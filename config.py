...
net_arg.add_argument('--res_x', type=int, default=16)
net_arg.add_argument('--res_y', type=int, default=16)
net_arg.add_argument('--res_z', type=int, default=16)
net_arg.add_argument('--repeat', type=int, default=3)
