REM ..\manta\build_nogui_vdb\Release\manta.exe ./scene/smoke3_vel_buo.py 
...
REM ..\manta\build_nogui\Release\manta.exe ./scene/liquid_pos_size.py --num_src_x_pos=10 --num_src_radius=4 --num_frames=200 --max_frames=199 --num_simulations=8000 --log_dir=data/liquid_pos10_size4_f200
..\manta\build_nogui\Release\manta.exe ./scene/smoke_pos_size.py
