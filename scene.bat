...
REM 2d
..\manta\build_nogui\Release\manta.exe ./scene/smoke_pos.py --num_src_x_pos=10 --num_frames=200 --max_frames=199 --num_simulations=2000 --clamp_mode=2 --time_step=0.5 --strength=0.1 --log_dir=D:/Polybox/dev/deep-fluids/data/smoke_pos10_f100_vc
