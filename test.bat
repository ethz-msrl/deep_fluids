...
REM smokegun
python main.py --is_3d=True --test_batch_size=5 --test_intv=250 --dataset=smoke3_vel5_buo3_f250 --res_x=112 --res_y=64 --res_z=32 --load_path=log/de/velocity/smoke3_vel5_buo3_f250/final/eval --is_train=False
